...
namespace webAppRestaurants.Controllers
{
    public class AdressesController : Controller
    {
        ...
        public AdressesController(RestaurantContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,num_voie,rue,cp,ville")] Adresse adresse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,num_voie,rue,cp,ville")] Adresse adresse)
        {
            if (id != adresse.ID)
            {
                return NotFound();
